export const TD = {
  ...
  heron:    { name:'Clever Heron',        icon:'🦩',  clr:'#6366f1', cost:70,  resCost:{stone:2,wood:2},  dmg:20, range:3.2, rate:42, pClr:'#818cf8', pSpd:20,  splash:0,   slow:0,  target:'last',    chain:3, chainRange:2, cat:'tower', desc:'Chain lightning · arcs to 3 targets · hits rearmost first' },
