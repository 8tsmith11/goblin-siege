export const TD = {
  ...
  fish:     { name:'Arrogant Fish',       icon:'🐟',  clr:'#f59e0b', cost:65,  resCost:{wood:2},          dmg:16, range:3.0, rate:45, pClr:'#fcd34d', pSpd:3.5, splash:1.2, slow:0,  target:'first',   cat:'tower', desc:'Splash damage · hits nearby enemies' },
  ...
  heron:    { name:'Clever Heron',        icon:'🦩',  clr:'#6366f1', cost:70,  resCost:{stone:2,wood:2},  dmg:20, range:3.2, rate:42, pClr:'#818cf8', pSpd:4,   splash:0,   slow:0,  target:'last',    chain:3, cat:'tower', desc:'Chain lightning · arcs to 3 targets · hits rearmost first' },
