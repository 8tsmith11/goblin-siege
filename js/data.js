export const TD = {
  ...
  clown:    { name:'Magnificent Clown',  icon:'🤡', clr:'#f472b6', cost:100, cat:'support', reverseRange:3, reverseDur:80, reverseCD:150, desc:'Targets one enemy and reverses their movement direction' },
...
export const TOWER_SKILLS = {
  ...
  penguin: {
    ...
    C: { name:'Blizzard',   desc:'AoE slow all in range',                excludes:'D', cost:{dust:50,gold:100}, owned:false, req:'any',   apply:tw=>{ tw.blizzard=true; } },
...
export const ETYPES = {
  normal:  { hpM:1,   spdM:1,   sz:.30, rew:1,  clr:'#22c55e', em:'👺', drops: [{ type: 'wood', chance: 0.10 }] },
  fast:    { hpM:.4,  spdM:1.6, sz:.24, rew:1,  clr:'#4ade80', em:'👺', drops: [{ type: 'wood', chance: 0.12 }] },
  tank:    { hpM:2.5, spdM:.6,  sz:.45, rew:3,  clr:'#a855f7', em:'👹', drops: [{ type: 'stone', chance: 0.14 }] },
  berserker:{ hpM:1.8,spdM:1.2, sz:.38, rew:2,  clr:'#ef4444', em:'😤', drops: [{ type: 'wood', chance: 0.14 }] },
  shaman:  { hpM:1.2, spdM:.9,  sz:.33, rew:2,  clr:'#f97316', em:'🧙', drops: [] },
  stealth: { hpM:.6,  spdM:1.4, sz:.22, rew:1,  clr:'#64748b', em:'👤', drops: [{ type: 'wood', chance: 0.12 }] },
  healer:  { hpM:.8,  spdM:.8,  sz:.30, rew:2,  clr:'#22d3ee', em:'💚', drops: [{ type: 'wood', chance: 0.10 }] },
